...
<div id="page-top">
	...
	<!-- start logo -->
	<div id="logo">
	<a href=""><img src="/RoboX/images/templatemo_logo.png" alt="RoboX"/></a>
	</div>
	<!-- end logo -->
...
<div class="nav-outer"> 
		...
		<ul class="select"><li><a href="/RoboX/underConstruction"><b>Dashboard</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<ul class="select"><li><a href="/RoboX/admin/edit_products"><b>Products</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		...
		<ul class="select"><li><a href="/RoboX/underConstruction"><b>Categories</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
		...
		<ul class="select"><li><a href="/RoboX/admin/edit_clients"><b>Clients</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
		...
		<ul class="current"><li><a href="/RoboΧ/admin/news"><b>News</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
